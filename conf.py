...
htmlhelp_basename = 'PythonPersianTutorialdoc'
...
man_pages = [
    (master_doc, 'pythonpersiantutorial', u'PythonPersianTutorial Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PythonPersianTutorial', u'PythonPersianTutorial Documentation',
   author, 'PythonPersianTutorial', 'One line description of project.',
   'Miscellaneous'),
]
